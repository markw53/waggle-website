        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuItem asChild>
                <Link to={ROUTES.PRICING} className="cursor-pointer flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <DropdownMenuItem asChild>
                <Link to={ROUTES.SUBSCRIPTION} className="cursor-pointer flex items-center gap-2 justify-between">
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <DropdownMenuSub>
                ...
                >
                  <DropdownMenuItem 
                    ...
                    className={`cursor-pointer ${theme === 'light' ? 'bg-amber-100 dark:bg-amber-900/30' : ''}`}
                  >
                    <span className="flex items-center gap-2 w-full">
                      ☀️ Light
                      {theme === 'light' && <span className="ml-auto text-amber-600">✓</span>}
                    </span>
                  </DropdownMenuItem>
                  <DropdownMenuItem 
                    onClick={() => setTheme('dark')} 
                    className={`cursor-pointer ${theme === 'dark' ? 'bg-amber-100 dark:bg-amber-900/30' : ''}`}
                  >
                    <span className="flex items-center gap-2 w-full">
                      🌙 Dark
                      {theme === 'dark' && <span className="ml-auto text-amber-600">✓</span>}
                    </span>
                  </DropdownMenuItem>
                  <DropdownMenuItem 
                    onClick={() => setTheme('system')} 
                    className={`cursor-pointer ${theme === 'system' ? 'bg-amber-100 dark:bg-amber-900/30' : ''}`}
                  >
                    <span className="flex items-center gap-2 w-full">
                      💻 System
                      {theme === 'system' && <span className="ml-auto text-amber-600">✓</span>}
                    </span>
                  </DropdownMenuItem>
                </DropdownMenuSubContent>
              </DropdownMenuSub>
